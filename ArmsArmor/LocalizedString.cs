...
namespace ArmsArmor
{
    class LocalizedStringHelper {
        ...
        static public void Init() {
            ...
            AddString(StringGuids.ImprovedTrip, "Improved Trip");
            ...
            AddString(StringGuids.SunderArmorDescription, "You provoke an attack of opportunity when performing a sunder combat maneuver.");
            AddString(StringGuids.ImprovedSunderArmor, "Improved Sunder Armor");
            AddString(StringGuids.ImprovedSunderArmorDescription, "You do not provoke an attack of opportunity when performing a sunder combat maneuver. In addition, you receive a +2 bonus on checks made to sunder an item. You also receive a +2 bonus to your Combat Maneuver Defense whenever an opponent tries to sunder your gear.");
            AddString(StringGuids.DisarmDescription, "You provoke an attack of opportunity when performing a disarm combat maneuver.");
            AddString(StringGuids.ImprovedDisarm, "Improved Disarm");
    ...
    class StringGuids {
        ...
        public const string ImprovedTrip = "41f5fa8f-c3ea-44aa-8684-430b67622401";
        public const string ImprovedTripDescription = "7138f6d7-67a5-4a74-95c5-b926617fc08b";
        public const string SunderArmorDescription = "d4d4cca5-f04f-462a-a221-c80e8c6360c9";
        public const string ImprovedSunderArmor = "8dcb8d8a-1857-4c86-bc97-5306a966cd5c";
        public const string ImprovedSunderArmorDescription = "baf4b4c7-720c-4aa4-94da-25e0992603e8";
        public const string DisarmDescription = "c8019a54-566c-4383-950b-c60d4ed384c4";
        public const string ImprovedDisarm = "2bd58dfc-1bac-4bc9-b038-e34cdc8b48d3";
        ...
        public const string SunderArmorFeature = "fd428ed5-beb2-4986-832b-5193f7424f9f";
