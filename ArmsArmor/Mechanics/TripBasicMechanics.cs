    ...
    public class TripBasicMechanics {
        ...
        static public BlueprintFeature GetBlueprint() {
            if (!blueprint) {
                ...
                component1.Facts = new BlueprintUnitFact[] { ResourcesLibrary.TryGetBlueprint<BlueprintAbility>(ExistingGuids.TripAction) };
                ...
                component2.name = "$Trip$596c260b-4309-4c94-a5d6-ee0127d1cd1b";
                ...
                Helpers.BlueprintUnitFactDisplayName(blueprint) = LocalizedStringHelper.GetLocalizedString(StringGuids.Trip);
