    ...
    public class DisarmBasicMechanics {
        ...
        static public BlueprintFeature GetBlueprint() {
            if (!blueprint) {
                ...
                var ability = ResourcesLibrary.TryGetBlueprint<BlueprintAbility>(ExistingGuids.DisarmAction);
                ...
                component2.name = "$ProvokeAttackOfOpportunity$047e3c6d-47dc-4ab6-8a2d-5f7e53addf29";
                ...
                Helpers.BlueprintUnitFactDisplayName(blueprint) = LocalizedStringHelper.GetLocalizedString(StringGuids.DisarmFeature);
